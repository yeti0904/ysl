...
namespace YSL {
	namespace Extensions {
		namespace System {
			...
			std::vector <int> GetEnv(std::vector <std::string> args, Environment& env) {
			...
			std::vector <int> SetEnv(std::vector <std::string> args, Environment& env) {
			...
			std::vector <int> UnSetEnv(std::vector <std::string> args, Environment& env) {
